/**
 * file-details-dialog.tsx — Main file details dialog
 *
 * Sub-components have been extracted to their own files:
 *   - dq-matrix-dialog.tsx  — DQ Matrix download dialog
 *   - row-wise-issues.tsx   — Expandable row-wise issues viewer
 */
import {
  Activity,
  AlertTriangle,
